			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-xl-2 col-lg-3 sidebar fixed-top">
						<a href="#" class="navbar-brand text-white text-center d-block mx-auto py-3 mb-4 bottom-border"><img src="images/admin/logo.png" alt="" width="150" onclick="javascript:location.href='manage_template.mdo'"></a>
						<div class="bottom-border pb-3" align="center">
							<img src="images/admin/profile.jpg" alt="" width="50" class="rounded-circle mr-2">
							<a href="#" class="text-white">admin</a>	
						</div>
						<ul class="navbar-nav flex-column mt-4">
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_dashboard.mdo')">
									<i class="fas fa-home text-white fa-lg mr-2"></i>DashBoard
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_movie.mdo')">
									<i class="fas fa-video text-white fa-lg mr-2"></i>영화
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_genre.mdo')">
									<i class="fas fa-envelope text-white fa-lg mr-2"></i>장르
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_director.mdo')">
									<i class="fas fa-shopping-cart text-white fa-lg mr-2"></i>감독
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_actor.mdo')">
									<i class="fas fa-chart-line text-white fa-lg mr-2"></i>영화배우
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_member.mdo')">
									<i class="fas fa-user text-white fa-lg mr-2"></i>회원
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_ticket.mdo')">
									<i class="fas fa-credit-card text-white fa-lg mr-2"></i>이용권
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_sales.mdo')"> 
							...
							<li class="dropdown nav-item"><a href="#" class="nav-link text-white p-2 mb-2 sidebar-link dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fas fa-question-circle text-white fa-lg mr-2"></i>고객센터</a>
								<ul class="dropdown-menu">
									<li><a class="nav-link text-white p-2 mb-2 sidebar-link" href="#" onclick="acyncMovePage('manage_cs.mdo')"><i class="fas fa-angle-right"></i>&nbsp;공지사항</a></li>
									<li><a class="nav-link text-white p-2 mb-2 sidebar-link" href="#" onclick="acyncMovePage('manage_cs.mdo')"><i class="fas fa-angle-right"></i>&nbsp;FAQ</a></li>
									<li><a class="nav-link text-white p-2 mb-2 sidebar-link" href="#" onclick="acyncMovePage('manage_cs.mdo')"><i class="fas fa-angle-right"></i>&nbsp;1:1 문의</a></li>
								</ul></li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_policy.mdo')">
									<i class="fas fa-file-signature text-white fa-lg mr-2"></i>이용약관
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_screen.mdo')">
									<i class="fas fa-tablet-alt text-white fa-lg mr-2"></i>화면
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_analysis.mdo')">
									<i class="fas fa-chart-line text-white fa-lg mr-2"></i>분석
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link text-white p-2 mb-2 sidebar-link" onclick="acyncMovePage('manage_manageraccount.mdo')">
