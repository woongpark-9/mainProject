...
<div class="position-relative" id="bodyContents" align="center" style="top: 5%;">
	<div class="col-md-5 mb-5" >
		<div class="page-header col-md-12" align="left" style="color: white; font-size: 4vw; border-bottom: 1px solid grey;">프로필 변경</div>
		<div class="col-md-12 mt-3" style="border-bottom: 1px solid grey;">
			<div class="row position-relative" style="height: 65%; width: 100%; padding: 0px;">
				...
				<div class="" style="width: 70%;">
					<div style="width: auto; height: 30%; border-bottom: 1px solid grey;">
						<input type="text" class="editname" value="${selectProfile.profile_name }" id="editname" style="font-size: 1.5vw;">
					</div>
					<div align="left" style="height: 40%; border-bottom: 1px solid grey;">
						<c:if test="${selectProfile.kids  == 'Y'}">
...
// 							        	${selectProfile.kids = 'N'};
					...
					<div style="height: 25%;" align="left">
						<div>
							<div  style="color:grey; font-size: 1.5vw;">
								자동 재생 설정
							</div>
							<div style="color:grey; font-size: 1.1vw;">
							<input type="checkbox" id="kidBox">
							<label for="kidBox"></label> 
							<span class="kidBox" role="checkbox" aria-checked="false" tabindex="1">모든 디바이스에서 시리즈의 다음 화 자동 재생</span>
							</div>
							<div style="color:grey; font-size: 1.1vw;">
							<input type="checkbox" id="kidBox">
							<label for="kidBox"></label> 
							<span class="kidBox" role="checkbox" aria-checked="false" tabindex="1">모든 디바이스에서 탐생 중 미리보기 자동 재생</span>
							</div>
						</div>
					</div>
				</div>
				<div class="mt-5" align="left" >
					<a href="#" class="next" onclick="acyncMovePage3('http://localhost:8080/nowflix/updateProfile.do', ${selectProfile.profile_id}, editname.value, '${selectProfile.profile_img }', kidhidden.value)">저장</a>
					<a href="#" class="cancel" onclick="acyncMovePage2('http://localhost:8080/nowflix/profile.do')">취소</a>
				</div>
			</div>
		</div>
	</div>
