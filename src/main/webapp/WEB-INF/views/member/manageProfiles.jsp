	...
	<div class="position-relative" id="bodyContents" style="top: 25%;">
		...
		<c:forEach var="profile" items="${profile }" varStatus="i">
			<div class="ml-3 mr-3 proImg">
				<a href="#" class="profile" onclick="acyncMovePage4('profileEdit.do', ${profile.profile_id}, '${profile.profile_name }', '${profile.profile_img }', '${profile.kids }')">
		...
		<c:if test="${fn:length(profile) <= 4}" >
			<div class="ml-3 mr-3 proImg">
				<a href="#" class="profile" onclick="acyncMovePage2('profileAdd.jsp')">
		...
		<div class="text-center mt-5">
    		<a href="#" class="col-mb-4 mt-6 complate" onclick="acyncMovePage('profile.do')">완료</a>
		</div>
	</div>
</body>
</html>